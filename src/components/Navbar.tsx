      ...
      <div className="max-w-md mx-auto flex justify-between items-center px-4 py-3">
        ...
        <Link href="/" onClick={onHome} className="flex items-center gap-2 group cursor-pointer">
          ...
          <div className="relative flex items-center justify-center">
            <div className="absolute inset-0 bg-red-500 rounded-full blur-md opacity-0 group-hover:opacity-60 transition-opacity duration-300"></div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
              strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
              className="text-[#ff7f50] group-hover:text-red-400 relative z-10 transition-all duration-300 group-hover:scale-110 group-hover:translate-x-1"
            >
          ...
          <span className="font-extrabold text-lg tracking-wider text-white transition-colors drop-shadow-md">
            TAXI <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-500 via-amber-400 to-red-400 drop-shadow-[0_0_10px_rgba(220,38,38,0.3)]">MANRRIQUE</span>
          </span>
        </Link>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="hidden sm:flex items-center gap-2 border border-white/10 px-3 py-1.5 rounded-full bg-white/5 backdrop-blur-md shadow-[0_0_15px_rgba(0,0,0,0.5)] cursor-default">
            ...
            <span className="relative flex h-2 w-2">
              ...
              <span className="relative inline-flex rounded-full h-2 w-2 bg-red-500 shadow-[0_0_5px_#dc2626]"></span>
            </span>
